...
export default function AppUpdateBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl m-3 sm:m-4 rounded-2xl border border-emerald-200 bg-white shadow-2xl shadow-emerald-100/50 p-4 flex flex-col sm:flex-row sm:items-center gap-4 safe-area-bottom">
        ...
        <button
          type="button"
          onClick={reloadNow}
          className="shrink-0 px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-[12px] font-bold transition-colors shadow-md shadow-emerald-200"
        >
          Refresh now
        </button>
      </div>
